...
<body>
<form action="donorsignuphelper.php" method="POST">
<div class="container mt-4">
    <h2 class="text-primary text-center">SignUp As Donor</h2>
  <div class="mb-3">
  <label for="name" class="form-label">Name</label>
    <input type="text" class="form-control" name="name" id="name" aria-describedby="emailHelp" required>
    <label for="phone" class="form-label">Phone No.</label>
    <input type="phone" class="form-control" name ="phone" id="phone" aria-describedby="emailHelp" maxlength=10 required>
  ...
  <p><a href="donorlogin.php" >Already Registered? Click Here To Login</a></p>
